 ...
 */
	...
	G_GNUC_INTERNAL int ipc3270_method_wait_for_cstate(GObject *session, GVariant *request, GObject *response, GError **error);
	G_GNUC_INTERNAL int ipc3270_method_wait_for_connected(GObject *session, GVariant *request, GObject *response, GError **error);
